package com.kware.policy.task.common.evaluation;
...
public class PerformanceLevelFinder {
    ...
    public PerformanceLevelFinder(String jsonFilePath) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        // JSON 파일을 읽어서 PerformanceLevel 객체 리스트로 변환
        performanceLevels = objectMapper.readValue(new File(jsonFilePath), new TypeReference<List<PerformanceLevel>>() {});
    }
